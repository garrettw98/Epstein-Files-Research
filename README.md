...
- **Latest (Sep 23, 2026):** [April-September 2026 Accountability Synthesis](analysis/April_September_2026_Accountability_Synthesis.md) — Bondi removed and Blanche confirmed; *Phang v. Blanche* court enforcement; House Oversight witness program and Leon Black contempt; reported SDNY probe of estate executors; UK arrests and Starmer's resignation; EFTA II.
...
## The 2026 Release (Updated Sep 23, 2026)

<!-- LIVE_UPDATES:START -->
### Live Updates (As of Sep 23, 2026)
...
*   **DOJ library status (Sep 23, 2026)**: DOJ's public Epstein repository remains live and currently lists releases through **Data Set 12**. [DOJ Epstein Library](https://www.justice.gov/epstein)
<!-- LIVE_UPDATES:END -->
...
- Claim-status diffs: added 35, removed 0, changed 0.
...
> **Pipeline note (Sep 23, 2026):** the network ingest steps could not run in the environment used for this update, so the brief above reflects claim-registry changes only. DOJ data-set counts and monitored links come from the last successful crawl (Mar 17, 2026). See the [Data Pipeline Runbook](docs/DATA_PIPELINE.md#network-requirements).
