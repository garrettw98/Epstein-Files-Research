...
- Generated UTC: 20260227T022356Z
...
| Coverage warnings | missing_datasets=0, media_endpoint_failures=4, stale_inputs=0 |
...
- Primary ingest run: 20260227T022350Z (0m ago).
- Universe ingest run: 20260227T021837Z (5m ago).
- Claim queue run: not reported in file (0m ago).
- Quality flags run: not reported in file (0m ago).
- Dataset completeness run: 20260227T022333Z (0m ago).
