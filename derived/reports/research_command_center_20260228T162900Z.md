...
- Generated UTC: 20260228T162900Z
...
| DOJ dataset coverage | 12/12 sets with files, 525 files indexed |
| Coverage warnings | missing_datasets=0, media_endpoint_failures=4, stale_inputs=1 |

## Change Pulse

- Primary-doc diffs: added=7, removed=4, changed=0.
...
- `stale_inputs` = 1. raw/epstein_universe/run_manifest_latest.json (38.2h old)
...
- Primary ingest run: 20260228T162855Z (0m ago).
- Universe ingest run: 20260227T021837Z (38.2h ago).
- Claim queue run: not reported in file (0m ago).
- Quality flags run: not reported in file (0m ago).
- Dataset completeness run: 20260228T162846Z (0m ago).
