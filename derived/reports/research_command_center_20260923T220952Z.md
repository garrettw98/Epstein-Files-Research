...
- Generated UTC: 20260923T220952Z
...
| Claims tracked | 44 (alleged=24, verified_primary=20) |
| Claims lacking tier-1 evidence links | 23 (alleged=23) |
...
- added: `claim-andrew-arrested-20260219` ( -> alleged)
- added: `claim-blanche-confirmed-ag-20260808` ( -> alleged)
- added: `claim-bofa-settlement-final-approval-20260827` ( -> alleged)
- added: `claim-bondi-removed-ag-20260402` ( -> alleged)
- added: `claim-bondi-transcribed-interview-20260529` ( -> verified_primary)
- added: `claim-doj-oig-efta-audit-20260423` ( -> alleged)
- added: `claim-efta2-discharge-218-20260918` ( -> alleged)
- added: `claim-european-mla-unanswered-20260909` ( -> alleged)

## Quality and Coverage Alerts

- `media_endpoint_failures` = 3. Outlet endpoints currently non-200/301/302 from latest status file.
- `stale_inputs` = 3. raw/primary_docs/run_manifest_latest.json (4579.8h old); raw/epstein_universe/run_manifest_latest.json (4579.9h old); derived/doj_epstein_library/epstein_library_index_latest.tsv (4579.9h old)
...
1. Backfill tier-1 links for 23 claim(s) in derived/reports/primary_evidence_gap_register_latest.tsv.
...
- Primary ingest run: 20260317T021929Z (190.8d ago).
- Universe ingest run: 20260317T021844Z (190.8d ago).
- Claim queue run: not reported in file (0m ago).
- Quality flags run: not reported in file (0m ago).
- Dataset completeness run: 20260317T021916Z (190.8d ago).
...
- Redaction categories: context_gap=5, unknown=36, victim_privacy=3.
