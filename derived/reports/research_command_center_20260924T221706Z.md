...
- Generated UTC: 20260924T221706Z
...
| Claims tracked | 92 (alleged=60, verified_primary=32) |
| Claims lacking tier-1 evidence links | 59 (alleged=59) |
...
- added: `claim-apollo-suits-consolidated-2026` ( -> verified_primary)
- added: `claim-bin-sulayem-mmc-202607` ( -> alleged)
- added: `claim-bloomberg-flight-bookings-20260724` ( -> alleged)
- added: `claim-bop-maxwell-letters-2026` ( -> verified_primary)
- added: `claim-christiansen-v-indyke-20260819` ( -> alleged)
- added: `claim-clayton-dni-sworn-20260803` ( -> verified_primary)
- added: `claim-coe-rapporteur-jagland-2026` ( -> alleged)
- added: `claim-estate-image-collection-suit-2026` ( -> alleged)

## Quality and Coverage Alerts

- `media_endpoint_failures` = 3. Outlet endpoints currently non-200/301/302 from latest status file.
- `stale_inputs` = 3. raw/primary_docs/run_manifest_latest.json (4604.0h old); raw/epstein_universe/run_manifest_latest.json (4604.0h old); derived/doj_epstein_library/epstein_library_index_latest.tsv (4604.0h old)
...
1. Backfill tier-1 links for 59 claim(s) in derived/reports/primary_evidence_gap_register_latest.tsv.
...
- Redaction categories: context_gap=6, national_security=1, unknown=76, victim_privacy=9.
