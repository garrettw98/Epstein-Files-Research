...
- Generated UTC: 20260924T224639Z
...
| Claims tracked | 110 (alleged=73, verified_primary=37) |
| Claims lacking tier-1 evidence links | 72 (alleged=72) |
...
- added: `claim-engelmayer-monitor-denied-20260121` ( -> alleged)
- added: `claim-gordon-brown-met-letter-20260203` ( -> alleged)
- added: `claim-ucsd-chopra-affiliation-ends-2026` ( -> alleged)
...
1. Backfill tier-1 links for 72 claim(s) in derived/reports/primary_evidence_gap_register_latest.tsv.
...
- Redaction categories: context_gap=6, national_security=1, unknown=93, victim_privacy=10.
