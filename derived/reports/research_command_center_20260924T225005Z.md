...
- Generated UTC: 20260924T225005Z
...
| Claims tracked | 113 (alleged=75, verified_primary=38) |
| Claims lacking tier-1 evidence links | 74 (alleged=74) |
...
- added: `claim-ny-s9960-introduced-20260417` ( -> verified_primary)
- added: `claim-usvi-bryan-texts-2019-reported-20260225` ( -> alleged)
- added: `claim-usvi-george-fbi-interview-20260130` ( -> alleged)

## Quality and Coverage Alerts

- `media_endpoint_failures` = 3. Outlet endpoints currently non-200/301/302 from latest status file.
- `stale_inputs` = 3. raw/primary_docs/run_manifest_latest.json (4604.5h old); raw/epstein_universe/run_manifest_latest.json (4604.5h old); derived/doj_epstein_library/epstein_library_index_latest.tsv (4604.5h old)
...
1. Backfill tier-1 links for 74 claim(s) in derived/reports/primary_evidence_gap_register_latest.tsv.
...
- Primary ingest run: 20260317T021929Z (191.9d ago).
- Universe ingest run: 20260317T021844Z (191.9d ago).
- Claim queue run: not reported in file (0m ago).
- Quality flags run: not reported in file (0m ago).
- Dataset completeness run: 20260317T021916Z (191.9d ago).
...
- Redaction categories: context_gap=6, national_security=1, unknown=95, victim_privacy=11.
