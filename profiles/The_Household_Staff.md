# 🧹 The Household Staff: The "Invisible" Witnesses

> **Status**: **KEY WITNESSES / POLICE INFORMANTS**

While the "Lieutenants" (Sarah Kellen, etc.) were participating in the abuse, the cleaning staff, house managers, and pilots were watching everything. Their testimony provides the most unvarnished look at the daily operations.

## 1. Juan Alessi (House Manager)
*   **Role**: Managed the Palm Beach property (1990-2002).
*   **Testimony**:
    *   He confirmed **Prince Andrew** stayed in the guest bedroom for weeks at a time.
    *   He testified that Prince Andrew and Sarah Ferguson received "massages" (though he didn't witness sexual acts with them directly).
    *   He described the "system": "The girls would come in, I would let them in, they would go to the massage room."

## 2. Alfredo Rodriguez (The Butler)
*   **Role**: House manager/Butler.
...
*   **Role**: Flew the Boeing 727 ("Lolita Express") and other aircraft for decades.
*   **The Logs**: They were required by FAA law to keep logs. These logs are the "Flight Manifests" we reference today.
*   **Testimony**:
